...
//24) 항목의 개수보다 작은 크기의 배열을 전달할 때, 자동으로 새 배열을 만들도록toArray(E[])를 변경한다.
public class MyArrayList24_a<E> {

  private static final int DEFAULT_CAPACITY = 5;
  private Object[] elementData;
  private int size;

  public MyArrayList24_a() {
    elementData = new Object[DEFAULT_CAPACITY];
  }

  public MyArrayList24_a(int initialCapacity) {
